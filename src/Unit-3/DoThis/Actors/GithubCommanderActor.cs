...
namespace GithubActors.Actors
{
    ...
    public class GithubCommanderActor : ReceiveActor, WithUnboundedStash
    {
        ...
        private void BecomeAsking()
        {
            ...
            // send ourselves a ReceiveTimeout message nif no message within 3 seconds
        ...
        private void Asking()
        {
            ...
            Receive<CanAcceptJob>(_canAcceptJobSender => Stash.Stash());
            ...
            // At least one actor failed to respond
        ...
        {
            // create a broadcase router who who will ask all of them if they're avaialble for work
            _coordinator = 
